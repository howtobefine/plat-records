<template>
  <teleport to="title">｜完成付款</teleport>
  <!-- banner -->
  <div class="container-fluid">
    <div class="row">
      <div
        ...
        "
      >
        <h2 class="text-center text-light display-5 mb-5 fw-bold pt-6">COMPLETED</h2>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb justify-content-center mb-0 fs-5">
            ...
            <li class="breadcrumb-item text-light active" aria-current="page">COMPLETED</li>
          </ol>
        </nav>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="text-center pb-6">
      <h2 class="mb-3">感謝你的購買！</h2>
      <p class="mb-4">謝謝你對於本店的支持，我們會盡快將盤送到您的唱盤上！</p>
      <div class="d-flex justify-content-center gap-3">
        <router-link to="/" class="btn btn-outline-danger rounded-pill px-5">回到首頁</router-link>
        <router-link to="/products" class="btn btn-danger rounded-pill px-5">繼續購物</router-link>
      </div>
    </div>
    <div class="row pb-5 pb-lg-9 gy-5">
      ...
      <div class="col-lg-6">
        <div class="card shadow-lg rounded-0 border-0 p-4">
          <h4 class="h5 mb-0 border-bottom pb-3">訂單資訊</h4>
